...
function UpdateSubmitButton()
{
    ...
    {
        submitCountFlag++;
        $('#email').fadeOut($.fx.speeds.testSpeed);
        $('label[for="email"]').fadeOut($.fx.speeds.testSpeed);
    }

    if ($("#pwd").val() !== '')
    {
        submitCountFlag++;
        $('#pwd').fadeOut($.fx.speeds.testSpeed);
        $('label[for="pwd"]').fadeOut($.fx.speeds.testSpeed);
    }
...
$('#del_item_button').click(
    ...
    {
        $('#sel1').animate({marginLeft: parseInt($("#sel1").css("marginLeft"))+1+"px"}, 10,'linear', Animation_one);
    }
);


$('#add_item_button_start').click(
    function Animation_two ()
    {
        $('#access_checker').animate({marginLeft: parseInt($("#access_checker").css("marginLeft"))+50+"px"},
            500,'swing', false);
    }
);

$('#add_item_button_end').click(
...
$('a[href="#vision"]').click(
    function Animation_five ()
    {
        $('a[href="#vestibular_apparatus"]').animate({marginLeft: 0+"px"},
            5000,'swing', false);
        return false;
    }
);

$('a[href="#hearing"]').click(
    function Animation_six ()
    {
        $('a[href="#vestibular_apparatus"]').stop();
        return false;
    }
);

$('a[href="#touch"]').click(
    function Animation_seven ()
    {
        $('a[href="#vestibular_apparatus"]').stop(true, true);
        return false;
    }
);
